...
<>
{/* <div > */}
      <div className="bg-gray-100 dark:bg-gray-900 w-64 h-full px-6 ">
        {/* <aside className="fixed top-25 z-10 ml-[-100%] flex h-screen w-full flex-col justify-between border-r bg-white px-6 pb-3 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%] dark:bg-gray-800 dark:border-gray-700"> */}
          <div className="h-full">
    

            <div className="mt-8 text-center">
              <img
                src="C:\Users\LENOVO\Desktop\bandy ka kam\my-app\src\images\logo.png"
                alt=""
                className="m-auto h-5 w-5 rounded-full object-cover lg:h-28 lg:w-28"
              />
              <h5 className="mt-4 hidden text-xl font-semibold text-gray-600 lg:block dark:text-Black-300">
                Cynthia J. Watts
              </h5>
            ...
            <ul className="mt-8 space-y-2 tracking-wide">
              ...
              <li>
                <a
                  href="/"
                  className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 dark:text-black-300"
                >
                  <svg
