    ...
    return (
       <>
          {/* Sidebar starts */}
            ...
            <div className="w-64 absolute sm:relative bg-gray-900 shadow md:h-full flex-col justify-between hidden sm:flex ">
                <div className="px-8">
                    <ul className="mt-14">
                        <li className="flex w-full justify-between text-gray-300 hover:text-gray-900 cursor-pointer items-center mb-6">
